...
// Inngest Function to send Remainder whwn a new connection request is added
const sendNewConnectionRequestRemainder = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        <div style="font-family: Arial, sans-serif; padding: 20px;">
            <h2>Hi ${connection.from_user_id.full_name},</h2>
        ...
        await step.run('send-connection-request-remainder', async () => {
            ...
            <p>You have a new connection request from ${connection.from_user_id.full_name} - 
            @${connection.from_user_id.username}</p>
            <p>Click <a href="${process.env.FRONTEND_URL}/connections" style="color: #10b981;">href</a> to accept or reject the request</p>
            <br/>
            <p>Thank,<br/>PingUp - Stay Connected</p>
            </div>`
...
// Inngest Function to delete story afet 24 hours
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    {cron: "TZ=Asia/Kolkata 30 18 * * *"}, // Every Day 6:30 PM
    async ({step}) => {
