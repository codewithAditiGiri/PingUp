...
const Feed = () => {
    ...
    return !loading ? (
        <div className='h-full overflow-y-scroll no-scrollbar py-10 xl:pr-5 flex items-start justify-center gap-6 xl:gap-8'>
            ...
            <div className='max-xl:hidden sticky top-0'>
                <div className='max-w-xs bg-white text-xs p-4 rounded-md inline-flex flex-col gap-2 shadow'>
                    ...
                    <img src={assets.sponsored_img} className='w-72 h-48 rounded-md object-cover' alt="" />
